...
private:
    ...
    GLuint modelViewMatrixUniform, projectionMatrixUniform;                     // Uniform locations
    GLuint ldUniform, kdUniform, lightPositionUniform;                          // Light uniform locations
    ...
    GLfloat materialDiffuse[4] = {0.5f, 0.5f, 0.5f, 1.0f};
...
OpenGLApp::OpenGLApp() : ghwnd(NULL), ghdc(NULL), ghrc(NULL), gpFile(NULL), shaderProgramObject(0),
                         vao(0), vbo_Position(0), vbo_Color(0), vbo_Texcoord(0), vbo_Normal(0), modelViewMatrixUniform(0), projectionMatrixUniform(0),
                         ldUniform(0), kdUniform(0), lightPositionUniform(0), keyPressedUniform(0),
